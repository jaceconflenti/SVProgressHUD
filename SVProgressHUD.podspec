Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/jaceconflenti/SVProgressHUD'
  s.authors  = { "Jace Conflenti" => "jace@squareup.com" }
  s.source   = { :git => 'https://github.com/jaceconflenti/SVProgressHUD.git', :tag => s.version.to_s }
  s.resource_bundles = {'SVProgressHUD_privacy' => ['SVProgressHUD/PrivacyInfo.xcprivacy']}
